        ...
        <!-- Academic Calendar Management Section -->
            <div class="section-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.academic-calendar.create')); ?>" class="btn btn-custom">
                            ...
                            <div class="row mb-4">
                                <div class="col-6">
                                    <div class="stats-card-modern">
                                        ...
                                        <div class="stats-content">
                                            <h4 class="stats-number"><?php echo e($upcomingEvents->count()); ?></h4>
                                ...
                                <div class="col-6">
                                    <div class="stats-card-modern">
                                        ...
                                        <div class="stats-content">
                                            <h4 class="stats-number"><?php echo e($thisMonthEvents->count()); ?></h4>
                            ...
                            <div class="card shadow-sm border-0 mb-4">
                                <div class="card-header bg-light">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-warning"><?php echo e($upcomingEvents->count()); ?></span>
                                    </div>
                                </div>
                                <div class="card-body" style="max-height: 300px; overflow-y: auto;">
                                    <?php if($upcomingEvents->count() > 0): ?>
                                        ...
                                        <div class="event-item-modern mb-3 p-3 rounded-3 event-type-<?php echo e($event->type); ?>">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="event-icon-modern event-icon-<?php echo e($event->type); ?>">
                                                        <?php echo $event->type_icon; ?>

                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1 fw-bold text-dark"><?php echo e(Str::limit($event->title, 25)); ?></h6>
                                                    <div class="event-meta">
                                                        <small class="text-muted d-block">
                                                            <i class="fas fa-calendar me-1"></i><?php echo e($event->formatted_date); ?>

                                                        </small>
                                                        <small class="text-primary fw-semibold">
                                                            <i class="fas fa-hourglass-half me-1"></i><?php echo e($event->days_until); ?>
                            ...
                            <div class="card shadow-sm border-0 mb-4">
                                <div class="card-header bg-light">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-info"><?php echo e($thisMonthEvents->count()); ?></span>
                                    </div>
                                </div>
                                <div class="card-body" style="max-height: 250px; overflow-y: auto;">
                                    <?php if($thisMonthEvents->count() > 0): ?>
                                        <?php $__currentLoopData = $thisMonthEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="month-event-item d-flex align-items-center mb-2 p-2 rounded-2 month-event-<?php echo e($event->type); ?>">
                                            <div class="event-dot me-3 event-dot-<?php echo e($event->type); ?>"></div>
                                            <div class="flex-grow-1">
                                                <small class="fw-bold text-dark d-block"><?php echo e(Str::limit($event->title, 20)); ?></small>
                                                <small class="text-muted"><?php echo e($event->event_date->format('M d, D')); ?></small>
                                            </div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            fetch('<?php echo e(route("admin.academic-calendar.events.data")); ?>?start=' + fetchInfo.startStr + '&end=' + fetchInfo.endStr)
        ...
        eventClick: function(info) {
            // Load event details
            fetch('<?php echo e(route("admin.academic-calendar.show", ":id")); ?>'.replace(':id', info.event.id))
                ...
                .then(html => {
                    ...
                    if (content) {
                        ...
                        document.getElementById('editEventBtn').href = '<?php echo e(route("admin.academic-calendar.edit", ":id")); ?>'.replace(':id', info.event.id);
...
<?php echo $__env->make('admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Tms_attendance_system\tms_attendance\resources\views/admin/academic/index.blade.php ENDPATH**/ ?>