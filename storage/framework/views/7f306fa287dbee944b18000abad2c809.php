        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 id="punched-in-count"><?php echo e($punchedInCount); ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 id="punched-out-count"><?php echo e($punchedOutCount); ?></h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3 id="current-time"><?php echo e(now()->format('H:i')); ?></h3>
                        <p>Current Time</p>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card">
                <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-users me-2"></i>Employee Attendance - <?php echo e(now()->format('l, F j, Y')); ?></h5>
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <!-- Employee Row -->
                        <div class="employee-row mb-3" data-employee-id="<?php echo e($employee->id); ?>">
                            <div class="row align-items-center">
                                        ...
                                        <div class="me-3">
                                            ...
                                            <?php else: ?>
                                                <div class="rounded-circle attendance-table-photo-placeholder bg-primary text-white d-flex align-items-center justify-content-center">
                                                    <span class="fw-bold"><?php echo e(strtoupper(substr($employee->first_name, 0, 1))); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div>
                                            <h6 class="mb-1 fw-bold text-truncate"><?php echo e($employee->full_name); ?></h6>
                                            <p class="mb-0 text-muted small text-truncate"><?php echo e($employee->position); ?></p>
                                ...
                                <div class="col-lg-2 col-md-2 text-center">
                                    <span class="badge employee-status-badge bg-light text-dark fw-normal" id="status-<?php echo e($employee->id); ?>">
                                ...
                                <div class="col-lg-4 col-md-5">
                                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                                        <button class="btn btn-success btn-sm punch-table-btn punch-in-btn-<?php echo e($employee->id); ?><?php echo e(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_in_time ? ' disabled' : ''); ?>"
                                                data-employee-id="<?php echo e($employee->id); ?>"
                                                data-action="punch_in"
                                                onclick="generateQRCode(<?php echo e($employee->id); ?>, 'punch_in')"
                                                <?php echo e(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_in_time ? 'disabled' : ''); ?>>
                                            <i class="fas fa-sign-in-alt me-1"></i>
                                            <span class="d-none d-sm-inline">Punch In</span>
                                            <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_in_time): ?>
                                                <small>(Done)</small>
                                            <?php endif; ?>
                                        </button>
                                        <button class="btn btn-danger btn-sm punch-table-btn punch-out-btn-<?php echo e($employee->id); ?><?php echo e(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_out_time ? ' disabled' : ''); ?>"
                                                data-employee-id="<?php echo e($employee->id); ?>"
                                                data-action="punch_out"
                                                onclick="generateQRCode(<?php echo e($employee->id); ?>, 'punch_out')"
                                                <?php echo e(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_out_time ? 'disabled' : ''); ?>>
                                            <i class="fas fa-sign-out-alt me-1"></i>
                                            <span class="d-none d-sm-inline">Punch Out</span>
                                            <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_out_time): ?>
                                                <small>(Done)</small>
                                            <?php endif; ?>
                                        </button>
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-12 text-center text-md-end mt-2 mt-md-0">
                                    <small class="text-muted d-block" id="last-activity-<?php echo e($employee->id); ?>">
                                        <i class="fas fa-clock me-1"></i>Never
                                    </small>
                                    <button class="btn btn-outline-primary btn-sm ms-2 toggle-details-btn"
                                            onclick="toggleEmployeeDetails(<?php echo e($employee->id); ?>)">
                            ...
                            <div class="employee-details-row mt-2" id="details-<?php echo e($employee->id); ?>" style="display: none;">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <span class="small"><?php echo e($employee->email ?? 'N/A'); ?></span>
                                                    </div>
                                                    <div class="col-6">
                                                        <small class="text-muted">Phone:</small><br>
                                                        <span class="small"><?php echo e($employee->phone ?? 'N/A'); ?></span>
                                                    </div>
                                                </div>
                                                <?php if($employee->employee && $employee->wfh_pin): ?>
                                                    <div class="row mt-2">
                                                        <div class="col-12">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <span class="small text-success" id="today-checkin-<?php echo e($employee->id); ?>">
                                                            <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_in_time): ?>
                                                                <?php echo e($todayAttendances[$employee->id]->punch_in_time->format('H:i')); ?>

                                                                <?php if($todayAttendances[$employee->id]->punch_in_source === 'manual'): ?>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <span class="small text-danger" id="today-checkout-<?php echo e($employee->id); ?>">
                                                            <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->punch_out_time): ?>
                                                                <?php echo e($todayAttendances[$employee->id]->punch_out_time->format('H:i')); ?>

                                                                <?php if($todayAttendances[$employee->id]->punch_out_source === 'manual'): ?>
                                                                    <small class="badge bg-info ms-1">Manual</small>
                                                                <?php else: ?>
                                                                    <small class="badge bg-primary ms-1">QR</small>
                                                                <?php endif; ?>
                                                ...
                                                <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->worked_hours): ?>
                                                <div class="row mt-2">
                                                    <div class="col-12">
                                                        <small class="text-muted">Worked Hours:</small><br>
                                                        <span class="small fw-bold text-primary"><?php echo e($todayAttendances[$employee->id]->formatted_worked_hours); ?></span>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                                <?php if(isset($todayAttendances[$employee->id]) && $todayAttendances[$employee->id]->attendance_type !== 'office'): ?>
                                                <div class="row mt-2">
                                                    <div class="col-12">
                                                        <small class="text-muted">Attendance Type:</small><br>
                                                        <span class="small badge bg-secondary">
                                                            <?php if($todayAttendances[$employee->id]->attendance_type === 'wfh'): ?>
                                                                <i class="fas fa-home me-1"></i>Work From Home
                                                            <?php elseif($todayAttendances[$employee->id]->attendance_type === 'hybrid'): ?>
...
let config = {
    qrGenerateUrl: '<?php echo e(route("admin.daily-attendance.generate-qr")); ?>',
    attendanceVerifyUrl: '<?php echo e(route("admin.daily-attendance.verify-qr")); ?>',
    csrfToken: '',
...
function startAttendanceStatusCheck() {
    ...
    config.statusCheckInterval = setInterval(async () => {
        try {
            const response = await fetch('<?php echo e(route("admin.daily-attendance.status-check", ":qrId")); ?>'.replace(':qrId', config.currentQrIdentifier), {
                method: 'GET',
                headers: {
                    'X-CSRF-TOKEN': config.csrfToken
                }
...
<?php echo $__env->make('admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\Tms_attendance_system\tms_attendance\resources\views/admin/attendance/index.blade.php ENDPATH**/ ?>