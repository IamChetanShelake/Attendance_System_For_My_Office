    ...
    <div class="main-content-wrapper">
        <div class="main-content" id="mainContent">
            ...
            <div class="page-header">
                <h1 class="page-title">
                    <i class="fas fa-clock me-2"></i>Create Office Timing Rule
                </h1>
                <p class="page-subtitle">Define standard working hours, breaks, and office timings for employees</p>
            </div>
            ...
            <div class="section-card">
                <div class="card-header bg-gradient-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-plus me-2"></i>Office Timing Configuration
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.office-rules.store') }}" id="ruleForm">
                        @csrf
                        <input type="hidden" name="rule_type" value="office_timing">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="rule_name"
                                           name="rule_name"
                                           value="{{ old('rule_name', 'Office Timing Policy - ' . date('M Y')) }}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('rule_description') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="Describe this office timing policy...">{{ old('rule_description') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="time" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.start_time', '09:00') }}"
                                           required>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="time" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.end_time', '18:00') }}"
                                           required>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.working_hours', 8) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="time" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.break_start', '13:00') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Break End Time</label>
                                    <input type="time" class="form-control"
                                           name="rule_settings[break_end]"
                                           value="{{ old('rule_settings.break_end', '14:00') }}">
                                </div>
                            </div>
                            <small class="text-muted">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" min="0" max="120"
                                           ...
                                           value="{{ old('rule_settings.grace_period_minutes', 15) }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               {{ old('rule_settings.strict_timing', false) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               value="1"
                                               {{ old('rule_settings.require_card_scan', true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" name="rule_settings[additional_notes]" rows="3"
                                              placeholder="Any special conditions, exceptions, or notes...">{{ old('rule_settings.additional_notes') }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.allow_flexible_hours', false) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.allow_early_leaving', true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                            Allow Early Leaving
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.allow_half_day', true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg">
                                            <i class="fas fa-save me-2"></i>Create Office Timing Policy
                                        </button>
                                    </div>
                                </div>
                            </div>
...
function loadDefaultSettings() {
    // Load standard 9-5 office hours
    ...
    alert('Standard office hours loaded successfully!');
}
