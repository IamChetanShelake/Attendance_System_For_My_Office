    ...
    <div class="main-content-wrapper">
        <div class="main-content" id="mainContent">
            ...
            <div class="page-header">
                <h1 class="page-title">
                    <i class="fas fa-edit me-2"></i>Edit Half Day Policy: {{ $rule->rule_name }}
                </h1>
                <p class="page-subtitle">Modify half-day attendance rules and automatic enforcement settings</p>
            </div>
            ...
            <div class="section-card">
                <div class="card-header bg-gradient-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Half Day Policy Configuration
                    </h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('rule_description') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="Describe this half-day policy and when it applies...">{{ old('rule_description', $rule->rule_description) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.half_day_hours', $rule->rule_settings['half_day_hours'] ?? 4) }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="time" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.half_day_threshold', $rule->rule_settings['half_day_threshold'] ?? '13:00') }}"
                                           required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="time" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.auto_half_day_trigger', $rule->rule_settings['auto_half_day_trigger'] ?? '12:00') }}">
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       {{ old('rule_settings.allow_morning_half', $rule->rule_settings['allow_morning_half'] ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       {{ old('rule_settings.allow_afternoon_half', $rule->rule_settings['allow_afternoon_half'] ?? true) ? 'checked' : '' }}>
                                                <label class="form-check-label">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.mandatory_break_required', $rule->rule_settings['mandatory_break_required'] ?? true) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.allow_partial_leave', $rule->rule_settings['allow_partial_leave'] ?? true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" step="0.1"
                                           ...
                                           value="{{ old('rule_settings.salary_deduction_percentage', $rule->rule_settings['salary_deduction_percentage'] ?? 50) }}"
                                           min="0" max="100">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" step="0.5"
                                           ...
                                           value="{{ old('rule_settings.leave_deduction_days', $rule->rule_settings['leave_deduction_days'] ?? 0.5) }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.max_consecutive_half_days', $rule->rule_settings['max_consecutive_half_days'] ?? 3) }}"
                                           min="1" max="10">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.requires_approval', $rule->rule_settings['requires_approval'] ?? true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.allow_auto_approval', $rule->rule_settings['allow_auto_approval'] ?? false) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.medical_exemption_allowed', $rule->rule_settings['medical_exemption_allowed'] ?? true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.emergency_exemption_allowed', $rule->rule_settings['emergency_exemption_allowed'] ?? true) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.max_half_days_per_month', $rule->rule_settings['max_half_days_per_month'] ?? 6) }}"
                                           min="1" max="15">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg">
                                            <i class="fas fa-save me-2"></i>Update Half Day Policy
                                        </button>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('statusText').textContent = statusCheckbox.checked ? '✅ Active' : '⏸️ Inactive';
});
    ...
    .then(data => {
        if (data.success) {
            ...
            document.getElementById('previewContent').innerHTML = `
                <strong>Half-day Hours:</strong> ${settings.half_day_hours || '4'} hours<br>
                <strong>Half-day Threshold:</strong> ${settings.half_day_threshold || '13:00'}<br>
                <strong>Salary Deduction:</strong> ${settings.salary_deduction_percentage || '50'}%<br>
                <strong>Leave Deduction:</strong> ${settings.leave_deduction_days || '0.5'} days<br>
                <strong>Max Consecutive:</strong> ${settings.max_consecutive_half_days || '3'} half-days<br>
...
function loadDefaultSettings() {
    ...
    // Load default half day settings
    ...
    document.querySelector('input[name="rule_settings[auto_half_day_trigger]"]').value = '12:00';
    ...
    document.querySelector('input[name="rule_settings[max_half_days_per_month]"]').value = '6';

    // Check relevant checkboxes
    const checkboxesToCheck = [
        'rule_settings[allow_morning_half]',
        'rule_settings[allow_afternoon_half]',
        'rule_settings[mandatory_break_required]',
        'rule_settings[allow_partial_leave]',
        'rule_settings[requires_approval]',
        'rule_settings[notify_supervisor]',
        'rule_settings[notify_hr]',
        'rule_settings[medical_exemption_allowed]',
        'rule_settings[emergency_exemption_allowed]'
    ];

    checkboxesToCheck.forEach(function(selector) {
        const checkbox = document.querySelector('input[name="' + selector + '"]');
        if (checkbox) {
    ...
    const checkboxesToUncheck = [
        'rule_settings[allow_auto_approval]',
