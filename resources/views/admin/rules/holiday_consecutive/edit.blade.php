    ...
    <div class="main-content-wrapper">
        <div class="main-content" id="mainContent">
            ...
            <div class="page-header">
                <h1 class="page-title">
                    <i class="fas fa-edit me-2"></i>Edit Holiday Consecutive Policy: {{ $rule->rule_name }}
                </h1>
                <p class="page-subtitle">Modify holiday consecutive leave rules, work-off policies, and approval settings</p>
            </div>
            ...
            <div class="section-card">
                <div class="card-header bg-gradient-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Holiday Consecutive Policy Configuration
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.office-rules.update', ['office_rule' => $rule]) }}" id="ruleForm">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('rule_description') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="Describe this holiday consecutive policy and how it handles holidays that fall on weekends...">{{ old('rule_description', $rule->rule_description) }}</textarea>
                        ...
                        <div class="settings-card mb-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-check form-switch mb-4">
                                        <input class="form-check-input"
                                               ...
                                               {{ old('rule_settings.holiday_consecutive.enabled', ($rule->rule_settings['holiday_consecutive']['enabled'] ?? true)) ? 'checked' : '' }}>
                            ...
                            <div class="row" id="holidayConsecutiveOptions" style="display: {{ old('rule_settings.holiday_consecutive.enabled', ($rule->rule_settings['holiday_consecutive']['enabled'] ?? true)) ? 'block' : 'none' }};">
                                <div class="col-md-12">
                                                ...
                                                <div class="combination-card p-3 border rounded">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                               ...
                                                               {{ old('rule_settings.holiday_consecutive.work_off_required', ($rule->rule_settings['holiday_consecutive']['work_off_required'] ?? true)) ? 'checked' : '' }}>
                                                ...
                                                <div class="combination-card p-3 border rounded">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                               ...
                                                               {{ old('rule_settings.holiday_consecutive.consecutive_treatment', ($rule->rule_settings['holiday_consecutive']['consecutive_treatment'] ?? true)) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="combination-card p-3 border rounded">
                                                    ...
                                                    <input type="number" class="form-control"
                                                           ...
                                                           value="{{ old('rule_settings.holiday_consecutive.work_off_deadline_days', ($rule->rule_settings['holiday_consecutive']['work_off_deadline_days'] ?? 30)) }}"
                                                           min="7" max="90">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="combination-card p-3 border rounded">
                                                    ...
                                                    <select class="form-select" name="rule_settings[holiday_consecutive][work_off_leave_type]">
                                                        <option value="casual" {{ old('rule_settings.holiday_consecutive.work_off_leave_type', ($rule->rule_settings['holiday_consecutive']['work_off_leave_type'] ?? 'casual')) == 'casual' ? 'selected' : '' }}>Casual Leave</option>
                                                        <option value="annual" {{ old('rule_settings.holiday_consecutive.work_off_leave_type', ($rule->rule_settings['holiday_consecutive']['work_off_leave_type'] ?? 'casual')) == 'annual' ? 'selected' : '' }}>Annual Leave</option>
                                                        <option value="compensatory" {{ old('rule_settings.holiday_consecutive.work_off_leave_type', ($rule->rule_settings['holiday_consecutive']['work_off_leave_type'] ?? 'casual')) == 'compensatory' ? 'selected' : '' }}>Compensatory Leave</option>
                                                    </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.calendar_integration_enabled', ($rule->rule_settings['calendar_integration_enabled'] ?? true)) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.public_holiday_weights', ($rule->rule_settings['public_holiday_weights'] ?? true)) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.holiday_categories.national', ($rule->rule_settings['holiday_categories']['national'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label">National Holidays</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               name="rule_settings[holiday_categories][regional]" value="1"
                                               {{ old('rule_settings.holiday_categories.regional', ($rule->rule_settings['holiday_categories']['regional'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label">Regional/State Holidays</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               name="rule_settings[holiday_categories][religious]" value="1"
                                               {{ old('rule_settings.holiday_categories.religious', ($rule->rule_settings['holiday_categories']['religious'] ?? true)) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{ old('rule_settings.adjacent_day_range', ($rule->rule_settings['adjacent_day_range'] ?? 1)) }}"
                                           min="1" max="3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.holiday_work_off_approval', ($rule->rule_settings['holiday_work_off_approval'] ?? true)) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.auto_process_consecutive', ($rule->rule_settings['auto_process_consecutive'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.flexible_work_off_periods', ($rule->rule_settings['flexible_work_off_periods'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.split_work_off_allowed', ($rule->rule_settings['split_work_off_allowed'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.carry_forward_work_off', ($rule->rule_settings['carry_forward_work_off'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.emergency_exemptions', ($rule->rule_settings['emergency_exemptions'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.senior_staff_exemptions', ($rule->rule_settings['senior_staff_exemptions'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.medical_exemptions', ($rule->rule_settings['medical_exemptions'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.detailed_reporting', ($rule->rule_settings['detailed_reporting'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.alert_unresolved_work_off', ($rule->rule_settings['alert_unresolved_work_off'] ?? true)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               ...
                                               {{ old('rule_settings.auto_escalation', ($rule->rule_settings['auto_escalation'] ?? false)) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold">
                        ...
                        <div class="settings-card mb-4">
                            ...
                            <textarea class="form-control" name="rule_settings[additional_notes]" rows="4"
                                      placeholder="Any additional policy notes about holiday consecutive rules and work-off requirements...">{{ old('rule_settings.additional_notes', ($rule->rule_settings['additional_notes'] ?? '')) }}</textarea>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg">
                                            <i class="fas fa-save me-2"></i>Update Holiday Consecutive Policy
                                        </button>
                                    </div>
                                </div>
                            </div>
