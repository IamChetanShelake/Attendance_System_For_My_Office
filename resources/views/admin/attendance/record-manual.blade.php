            ...
            <div class="section-card mb-4">
                <div class="card-header bg-gradient-manual text-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-actions">
                        <a href="{{ route('admin.manage-attendance') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('admin.manage-attendance.record') }}" class="attendance-form" id="attendanceForm">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text">
                                            <span class="employee-count">{{ $employees->count() }}</span>
                            ...
                            <div class="text-center">
                                        ...
                                        <div class="confirmation-details text-left">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <strong>Time:</strong> <span id="confirmTime" class="text-muted">{{ now()->format('H:i:s') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                ...
                                <div class="mt-3">
                                    <small class="text-muted">
                                        ...
                                        Current time: <span class="current-time fw-bold">{{ now()->format('l, F j, Y \a\t H:i:s') }}</span>
                                    </small>
                                </div>
                            </div>
                        </div>
