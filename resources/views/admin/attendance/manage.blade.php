            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3>{{ $todayAttendances->where('punch_in_source', 'manual')->count() }}</h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3>{{ $todayAttendances->where('punch_out_source', 'manual')->count() }}</h3>
                ...
                <div class="col-md-3">
                    <div class="stats-card">
                        ...
                        <h3>{{ $employees->where('wfh_pin', '!=', null)->count() }}</h3>
            ...
            <div class="section-card mb-4">
                <div class="card-header bg-gradient-info text-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-actions">
                        <a href="{{ route('admin.manual-attendance') }}" class="btn btn-light btn-lg">
            ...
            <div class="section-card">
                ...
                <div class="card-body">
                    @forelse($employees as $employee)
                        <div class="employee-attendance-card border rounded p-3 mb-3 {{ $employee->photo ? 'has-photo' : '' }}"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 fw-bold">{{ $employee->full_name }}</h6>
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="attendance-status">
                                        @if(isset($todayAttendances[$employee->id]))
                                            @php $attendance = $todayAttendances[$employee->id] @endphp
                                            <div class="row">
                                                <div class="col-6">
                                                    <small class="d-block text-muted">Check In:</small>
                                                    <span class="badge {{ $attendance->punch_in_source === 'manual' ? 'bg-info' : 'bg-primary' }}">
                                                        {{ $attendance->punch_in_time?->format('H:i') ?? '--:--' }}
                                                        @if($attendance->punch_in_source === 'manual')
                                                            <small>(Manual)</small>
                                                        @endif
                                                    </span>
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <span class="badge {{ $attendance->punch_out_source === 'manual' ? 'bg-info' : 'bg-danger' }}">
                                                        {{ $attendance->punch_out_time?->format('H:i') ?? '--:--' }}
                                                        @if($attendance->punch_out_source === 'manual')
                                                            <small>(Manual)</small>
                                                        @endif
                                                    </span>
                                                </div>
                                            ...
                                            @if($attendance->worked_hours)
                                                <div class="mt-1">
                                                    ...
                                                    <span class="badge bg-info">{{ $attendance->formatted_worked_hours }}</span>
                                                </div>
                                            @endif
                                        @else
                                    ...
                                    @if(isset($todayAttendances[$employee->id]))
                                        ...
                                        <div>
                                            <div class="badge bg-secondary mb-1">
                                                <i class="fas fa-{{ $attendance->attendance_type === 'wfh' ? 'home' : ($attendance->attendance_type === 'hybrid' ? 'exchange-alt' : 'building') }} me-1"></i>
                                                {{ ucfirst($attendance->attendance_type) }}
                                            </div>
                                            <br>
                                            <small class="text-muted">
                                                @if($attendance->punch_in_source || $attendance->punch_out_source)
                                                    {{ $attendance->punch_in_source === 'manual' || $attendance->punch_out_source === 'manual' ? 'Manual Entry' : 'Auto Entry' }}
                                                @endif
                                            </small>
                                        </div>
                                    @else
                                ...
                                <div class="col-lg-2 col-md-1 text-end">
                                    <div class="btn-group" role="group">
                                        <button class="btn btn-sm btn-outline-primary quick-select"
                                                ...
                                                data-has-pin="{{ $employee->wfh_pin ? 'yes' : 'no' }}"
